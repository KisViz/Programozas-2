...
//
//public:
//    VilagitoDisz(): fenyesseg(0) {}
//
//    explicit VilagitoDisz(unsigned fenyesseg) : fenyesseg(fenyesseg) {}
//
...
//
//public:
//    explicit KisKaracsonyfa(const string &tipus = "luc") : tipus(tipus) {}
//
//    KisKaracsonyfa (const KisKaracsonyfa &other): tipus(other.tipus), csucsdisz(new VilagitoDisz){
//        *csucsdisz = *other.csucsdisz;
//    }
//
...
//    }
//
//    void disz_felhelyezese(const VilagitoDisz& vilagitoDisz) {
//        delete csucsdisz;
//        csucsdisz = new VilagitoDisz(vilagitoDisz);
//    }
//
...
//    unsigned int get_fenyesseg() const {
//        if (csucsdisz) {
//            return csucsdisz->get_fenyesseg();
//        } else {
//            return 0;
//        }
//    }
...
//        const VilagitoDisz vd40(100);
//        fa.disz_felhelyezese(vd40);
//        std::cout <<  fa.get_csucs_disz()->get_fenyesseg() << std::endl;
//        assert(fa.get_csucs_disz()->get_fenyesseg() == 100);
//    }
//    {
//        VilagitoDisz vd2(20);
//        ++vd2;
